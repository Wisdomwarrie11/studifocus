  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-500">Test your retention to unlock next week.</p>
      </div>

      {!submitted ? (
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
          <div className="bg-gray-50 px-6 py-3 border-b border-gray-100 flex justify-between">
            <span className="text-sm font-medium text-gray-500">Question {currentQuestionIndex + 1} of {assessment.questions.length}</span>
            <span className="text-sm font-medium text-primary">Passing Score: {assessment.passingScore}%</span>
          </div>
          ...
          <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-between">
            <button
              ...
              className="text-gray-500 disabled:opacity-50 font-medium hover:text-gray-700"
            >
              Previous
            </button>
            ...
            {currentQuestionIndex < assessment.questions.length - 1 ? (
              ...
              <button
                ...
                className="bg-green-600 text-white px-6 py-2 rounded-lg font-medium hover:bg-green-700 shadow-lg shadow-green-200"
              >
                Submit Assessment
              </button>
            )}
        ...
        <div className="bg-white rounded-2xl shadow-lg p-10 text-center">
          <div className={`w-20 h-20 mx-auto rounded-full flex items-center justify-center mb-4 ${score >= assessment.passingScore ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'}`}>
            {score >= assessment.passingScore ? <CheckCircle size={40} /> : <XCircle size={40} />}
          </div>
          ...
          <button
            ...
            className="bg-primary text-white px-8 py-3 rounded-xl font-semibold hover:bg-indigo-700"
          >
            Return to Dashboard
          </button>
        </div>
